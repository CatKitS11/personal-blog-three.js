...
import CardAuthor from "@/features/blog/CardAuthor";
import LikeAndShareBar from "@/features/blog/LikeAndShareBar";
import CommentPost from "@/features/blog/CommentPost";
            ...
            <ReactMarkdown
              ...
              components={{
                img: ({ node, ...props }) => (
                  <img
                    {...props}
                    className="rounded-lg my-6 max-w-full h-auto mx-auto object-contain"
                ...
                code: ({ node, inline, ...props }) =>
                  inline ? (
                    ...
                    <code
                      {...props}
                      className="block bg-gray-100 p-4 rounded-lg my-4 overflow-x-auto font-mono text-sm"
                    />
                  ),
              }}
            >
